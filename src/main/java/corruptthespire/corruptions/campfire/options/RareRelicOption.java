...
public class RareRelicOption extends AbstractCorruptedCampfireOption {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("CorruptTheSpire:RareRelicOption");
    ...
    public void useOption() {
        ...
        AbstractDungeon.effectList.add(new CorruptedCampfireGainRelicEffect(AbstractRelic.RelicTier.RARE));
    }
}
