...
public class OtherworldlyPackParticleEffect extends AbstractGameEffect {
    ...
    public OtherworldlyPackParticleEffect(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.color = new Color(0.02F, 0.0F, 0.02F, 0.6F);
        this.duration = 0.7F;
    ...
    private void updateMovement() {
        ...
        if (this.target.dst(this.pos) < DST_THRESHOLD) {
            ...
            CardCrawlGame.sound.playAV("POWER_FOCUS", MathUtils.random(0.6F, 0.9F), 0.5F);
