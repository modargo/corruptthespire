...
public class Doom extends CustomMonster
{
    ...
    private static final int DEATHBEAM_DAMAGE = 13;
    private static final int A3_DEATHBEAM_DAMAGE = 15;
    private static final int KARMIC_JUDGEMENT_DAMAGE = 9;
    private static final int A3_KARMIC_JUDGEMENT_DAMAGE = 10;
    ...
    private static final int A8_HP_MAX = 140;
