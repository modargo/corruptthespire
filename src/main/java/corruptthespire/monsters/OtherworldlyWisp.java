...
public class OtherworldlyWisp extends CustomMonster
{
    ...
    private static final int DANCING_LIGHTS_BLOCK = 4;
    private static final int A7_DANCING_LIGHTS_BLOCK = 5;
    private static final int RAY_DAMAGE = 5;
    private static final int A2_RAY_DAMAGE = 6;
    private static final int ENERGIZE_DAMAGE = 3;
    private static final int A2_ENERGIZE_DAMAGE = 4;
    ...
    private static final int RADIANT_HEAL = 5;
    private static final int A17_RADIANT_HEAL = 8;
