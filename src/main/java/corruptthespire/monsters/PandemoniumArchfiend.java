...
public class PandemoniumArchfiend extends CustomMonster
{
    ...
    private static final int TORMENTING_SHACKLES_DAMAGE = 28;
    private static final int A4_TORMENTING_SHACKLES_DAMAGE = 31;
    private static final int TORMENTING_SHACKLES_AMOUNT = 1;
    private static final int INFERNAL_POWER_DAMAGE = 20;
    private static final int A4_INFERNAL_POWER_DAMAGE = 22;
    private static final int INFERNAL_POWER_RITUAL = 2;
    private static final int A19_INFERNAL_POWER_RITUAL = 3;
