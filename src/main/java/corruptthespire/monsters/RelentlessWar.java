...
public class RelentlessWar extends CustomMonster
{
    ...
    private static final int BLOODSHED_DAMAGE = 11;
    private static final int A4_BLOODSHED_DAMAGE = 13;
    private static final int SLAUGHTER_DAMAGE = 7;
    private static final int A4_SLAUGHTER_DAMAGE = 8;
