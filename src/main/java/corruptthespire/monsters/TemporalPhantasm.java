...
public class TemporalPhantasm extends CustomMonster
{
    ...
    private static final int GRADUAL_DECAY_DAMAGE = 4;
    private static final int A4_GRADUAL_DECAY_DAMAGE = 5;
    ...
    private static final int TEMPORAL_DISTORTION_DAMAGE = 11;
    private static final int A4_TEMPORAL_DISTORTION_DAMAGE = 13;
    ...
    private static final int A9_METALLICIZE = 20;
